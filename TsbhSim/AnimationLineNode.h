...
#ifndef VISUALIZATION_ANIMATED_LINE_H
#define VISUALIZATION_ANIMATED_LINE_H
...
namespace osgEarth { class LineDrawable; }
	...
	*/
	class RTSSCORE_EXPORT AnimatedLineNode : public osg::MatrixTransform
	{
	public:
		/**
		...
		*/
		void setEndPoints(const Locator* first, const Coordinate& second);
		...
		*/
		...
		int getEndPoints(MultiFrameCoordinate& coord1, MultiFrameCoordinate& coord2) const;
		...
		*/
		...
		virtual const char* libraryName() const { return "tsbhsim"; }
	...
	private:
		...
		osgEarth::Util::SimpleMutable<MultiFrameCoordinate> firstCoord_;
		/**
		...
		*/
		osgEarth::Util::SimpleMutable<Coordinate> secondCoord_;
		/** ... but we still save the most recently resolved MF coordinate, only set when drawing. */
		osgEarth::Util::SimpleMutable<MultiFrameCoordinate> secondCoordMF_;
		...
		*/
		...
		bool doesLineIntersectEarth_(const MultiFrameCoordinate& coord1, const MultiFrameCoordinate& coord2) const;

		/** Sets up the line vertices and primitive geometry, choosing straight or bending as appropriate */
		void drawLine_(const MultiFrameCoordinate& coord1, const MultiFrameCoordinate& coord2);
		/**
		...
		*/
		void drawBendingLine_(const MultiFrameCoordinate& coord1, const MultiFrameCoordinate& coord2);
		/** Draws a straight line.  Coord1 must be LLA or ECEF.  Fastest with ECEF coordinate. */
		void drawSlantLine_(const MultiFrameCoordinate& startPoint, const MultiFrameCoordinate& endPoint);
	};
