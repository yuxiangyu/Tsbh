...
#include "TsbhSim_global.h"
  ...
  */
  ...
  class RTSSCORE_EXPORT CoordinateConverter
  {
  public:
    ...
    */
    const SimVec3& referenceOrigin() const;
    ...
    */
    void setReferenceOriginDegrees(const SimVec3 &lla);
    ...
    */
    void setReferenceOrigin(const SimVec3 &lla);
    ...
    * @pre out param valid
    */
    static void swapNedEnu(const SimVec3 &inVec, SimVec3 &outVec);
    ...
    * @pre out param valid
    */
    static void swapNedNwu(const SimVec3 &inVec, SimVec3 &outVec);
    ...
    * @pre out param valid
    */
    static void convertEnuToNwu(const SimVec3 &inVec, SimVec3 &outVec);
    ...
    * @pre out param valid
    */
    static void convertNwuToEnu(const SimVec3 &inVec, SimVec3 &outVec);
    ...
    * @pre out param valid
    */
    static void convertGeodeticPosToEcef(const SimVec3 &llaPos, SimVec3 &ecefPos, double semiMajor = WGS_A, double eccentricitySquared = WGS_ESQ);
    ...
    * @pre out param valid
    */
    static void convertGeodeticOriToEcef(const SimVec3 &llaPos, const SimVec3 &llaOri, SimVec3 &ecefOri, LocalLevelFrame localLevelFrame = LOCAL_LEVEL_FRAME_NED);
    ...
    * @pre out param valid
    */
    static int convertEcefToGeodeticPos(const SimVec3 &ecefPos, SimVec3 &llaPos);
    ...
    * @pre out param valid
    */
    static void convertEcefToGeodeticVel(const SimVec3 &llaPos, const SimVec3 &ecefVel, SimVec3 &llaVel, LocalLevelFrame localLevelFrame = LOCAL_LEVEL_FRAME_NED);
    ...
    * @pre out param valid
    */
    static void convertEcefToGeodeticOri(const SimVec3 &llaPos, const SimVec3 &ecefOri, SimVec3 &llaOri, LocalLevelFrame localLevelFrame = LOCAL_LEVEL_FRAME_NED);
    ...
    * @pre out param valid
    */
    static void convertEcefToGeodeticAccel(const SimVec3 &llaPos, const SimVec3 &ecefAcc, SimVec3 &llaAcc, LocalLevelFrame localLevelFrame = LOCAL_LEVEL_FRAME_NED);
  ...
  private: // data
	...
	SimVec3 referenceOrigin_;               /// reference origin, lat(rad), lon(rad), alt relative to surface of ellipsoid (m)
	...
	SimVec3 tangentPlaneTranslation_;       /// ENU tangent plane translation vector
  ...
  private: // methods
    ...
    */
    void calculateReferenceRadius_(const SimVec3 &lla);
