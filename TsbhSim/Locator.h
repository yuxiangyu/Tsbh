 ...
 */
class RTSSCORE_EXPORT Locator : public osg::Referenced, public osgEarth::Util::Revisioned
{
public:
  /**
...
public:
  ...
  */
  void setCoordinate(const Coordinate& coord, double timestamp,
  ...
  */
   ...
   * @param[in ] notify Whether to immediately notify listeners
   */
  void setLocalOffsets(const SimVec3& pos, const SimVec3& ori,
  ...
  */
  bool getCoordinate(Coordinate* out_coord, const CoordinateSystem& coordsys = COORD_SYS_ECEF) const;
   ...
   * @return True upon success.
   */
  bool getLocalOffsets(SimVec3& out_pos, SimVec3& out_ori) const;

  /**
   * Convenience; returns a reference to the absolute coordinate in its default
   * internal representation
   */
  const Coordinate& getCoordinate() const { return ecefCoord_; }
  ...
  */
  virtual bool getLocatorPosition(SimVec3* out_position,
    const CoordinateSystem& coordsys = COORD_SYS_ECEF) const;
  ...
  * @return True if the output parameter is populated successfully
  */
  virtual bool getLocatorPositionOrientation(SimVec3* out_position, SimVec3* out_orientation,
    const CoordinateSystem& coordsys = COORD_SYS_ECEF) const;
...
private:
  ...
  */
  ...
  Coordinate ecefCoord_; ///< the base position & orientation of this locator, possibly unset
  SimVec3 offsetPos_; ///< the local position offset of this locator, possibly unset
  SimVec3 offsetOri_; ///< the local orientation offset of this locator, possibly unset
...
*/
class RTSSCORE_EXPORT CachingLocator : public Locator
{
public:
  ...
  */
  virtual bool getLocatorPosition(SimVec3* out_position,
    const CoordinateSystem& coordsys = COORD_SYS_ECEF) const override;
...
private:
  ...
  mutable SimVec3 llaPositionCache_;
  mutable osgEarth::Util::Revision llaPositionCacheRevision_;
  mutable SimVec3 llaOrientationCache_;
...
*/
class RTSSCORE_EXPORT ResolvedPositionOrientationLocator : public Locator
{
public:
  /** Constructor; @see Locator() */
...
* The inherited position matrix will represent a local tangent plane at the final position.
*/
class RTSSCORE_EXPORT ResolvedPositionLocator : public ResolvedPositionOrientationLocator
{
public:
  /** Constructor; @see Locator() */
