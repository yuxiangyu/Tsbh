...
/// Container for enumerations and constants relating to coordinate system calculations and conversion
   ...
   */
  RTSSCORE_EXPORT std::string coordinateSystemToString(CoordinateSystem coordSystem);
   ...
   */
  RTSSCORE_EXPORT int coordinateSystemFromString(const std::string& str, CoordinateSystem& outSystem);
