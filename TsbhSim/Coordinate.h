...
#include "TsbhSim_global.h"
  ...
  */
  class RTSSCORE_EXPORT Coordinate
  {
  public:
    Coordinate();
    /// value constructor
    Coordinate(CoordinateSystem system, const SimVec3 &pos, double elapsedECITime = 0.0);
    /// value constructor
    Coordinate(CoordinateSystem system, const SimVec3 &pos, const SimVec3 &ori, double elapsedECITime = 0.0);
    /// value constructor
    Coordinate(CoordinateSystem system, const SimVec3 &pos, const SimVec3 &ori, const SimVec3 &vel, double elapsedECITime = 0.0);
    /// value constructor
    Coordinate(CoordinateSystem system, const SimVec3 &pos, const SimVec3 &ori, const SimVec3 &vel, const SimVec3 &acc, double elapsedECITime = 0.0);
    /// copy constructor
    ...
    */
    void setPosition(const SimVec3 &pos);
    ...
    */
    void setOrientation(const SimVec3 &ori);
    ...
    */
    void setVelocity(const SimVec3 &vel);
    ...
    */
    void setAcceleration(const SimVec3 &acc);
    ...
    */
    const SimVec3 &position() const { return pos_; }
    ...
    */
    const SimVec3 &orientation() const { return ori_; }
    ...
    */
    const SimVec3 &velocity() const { return vel_; }
    ...
    */
    const SimVec3 &acceleration() const { return acc_; }
  ...
  private:
	...
	SimVec3 pos_;                ///< position: radians and meter for geodetic, meters for remaining coordinates
	SimVec3 vel_;                ///< velocity: meters/sec
	SimVec3 ori_;                ///< orientation: radians
	SimVec3 acc_;                ///< acceleration: meters/sec^2
